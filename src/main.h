...
class Main : public CecCallback {
    ...
    private:
        ...
        /* daemon primary address */
        CEC::cec_logical_address myAddress;
    ...
    public:
        ...
        void setDeviceAddress(const HDMI::address & address) {cec.setDeviceAddress(address);};
        void setDeviceName(const std::string &name) {cec.setDeviceName(name);};
};
